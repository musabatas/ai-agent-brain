...
const inputVariants = cva(
  ...
  `,
  {
    variants: {
      variant: {
        lg: 'h-11 px-4 text-[0.9375rem] rounded-lg file:pe-4 file:me-4',
        md: 'h-10 px-3.5 text-sm rounded-lg file:pe-3.5 file:me-3.5',
        sm: 'h-8 px-3 text-[0.8125rem] rounded-md file:pe-3 file:me-3',
      },
    },
    defaultVariants: {
      variant: 'md',
...
const inputAddonVariants = cva(
  'flex items-center shrink-0 justify-center bg-muted border border-input shadow-xs shadow-[rgba(0,0,0,0.05)] text-secondary-foreground [&_svg]:text-secondary-foreground/60',
  {
    variants: {
      variant: {
        sm: 'rounded-md h-8 min-w-8 text-[0.8125rem] px-3 [&_svg:not([class*=size-])]:size-3.5',
        md: 'rounded-lg h-10 min-w-10 px-3.5 text-sm [&_svg:not([class*=size-])]:size-4.5',
        lg: 'rounded-lg h-11 min-w-11 px-4 text-[0.9375rem] [&_svg:not([class*=size-])]:size-4.5',
      },
      mode: {
        default: '',
