...
const buttonVariants = cva(
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      ...
      size: {
        lg: 'h-11 rounded-lg px-5 text-[0.9375rem] gap-2 [&_svg:not([class*=size-])]:size-4.5',
        md: 'h-10 rounded-lg px-4 gap-2 text-sm [&_svg:not([class*=size-])]:size-4',
        sm: 'h-8 rounded-md px-3 gap-1.5 text-[0.8125rem] [&_svg:not([class*=size-])]:size-3.5',
        icon: 'size-10 rounded-lg [&_svg:not([class*=size-])]:size-4.5 shrink-0',
      },
      autoHeight: {
        true: '',
        false: '',
    ...
    compoundVariants: [
      ...
      },
      {
        size: 'md',
        mode: 'icon',
        className: 'w-10 h-10 p-0 [&_svg:not([class*=size-])]:size-4.5',
      },
      {
        size: 'icon',
        className: 'w-10 h-10 p-0 [&_svg:not([class*=size-])]:size-4.5',
