...
export default function OnboardingPage() {
  ...
  const createOrg = useMutation({
    mutationFn: async (values: { orgName: string }) => {
      ...
      setOrgId(newOrgId);
      if (newOrgId) {
        storeOption('activeOrgId', newOrgId);
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-[520px] space-y-8">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center size-12 rounded-xl bg-primary/10 animate-pulse">
          ...
          <div className="bg-card border rounded-xl p-6">
            ...
            <div className="space-y-5">
              {apiKey && (
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <code className="font-mono flex-1 bg-muted px-3 py-2.5 rounded-md text-xs break-all">
                      {apiKey}
                    </code>
                    <Button
                      size="sm"
              ...
              <div className="space-y-2">
                ...
                <pre className="font-mono bg-zinc-950 text-zinc-300 p-4 rounded-lg text-xs overflow-x-auto border border-zinc-800">
                  <code>
                    {mcpConfig.split('\n').map((line, i) => (
              ...
              {projectSlug && (
                <div className="space-y-1.5">
                  <p className="text-xs text-muted-foreground/60">
                    The <code className="font-mono text-primary/70">X-Project-Slug</code> header is already set in the config above.
                    Your AI agent will automatically target this project — no need to pass a project slug on each tool call.
                  </p>
                </div>
              )}
              ...
              <div className="text-xs text-muted-foreground space-y-1.5">
                <p>
                  ...
                  Add to <code className="font-mono">.mcp.json</code> in your
                  project root
                </p>
                <p>
                  <Badge variant="outline" className="text-xs mr-1.5">
